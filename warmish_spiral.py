...
"""Same as warm_spiral2.py but with velocity dispersion 20km/s instead of 40km/s"""
...
dfc = dehnendf(beta=0, profileParams=(1/3, 1, 20/220), correct=True, niter=20)
...
pickle_data('./pickles/warmish_spiralA.pkl', oortA_array)
pickle_data('./pickles/warmish_spiralB.pkl', oortB_array)
pickle_data('./pickles/warmish_spiralC.pkl', oortC_array)
pickle_data('./pickles/warmish_spiralK.pkl', oortK_array)