...
pickle_data('./pickles/cold_spiral_OLR_A.pkl', oortA_array)
pickle_data('./pickles/cold_spiral_OLR_B.pkl', oortB_array)
pickle_data('./pickles/cold_spiral_OLR_C.pkl', oortC_array)
pickle_data('./pickles/cold_spiral_OLR_K.pkl', oortK_array)