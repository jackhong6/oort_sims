...
pickle_data('./pickles/cold_spiralA.pkl', oortA_array)
pickle_data('./pickles/cold_spiralB.pkl', oortB_array)
pickle_data('./pickles/cold_spiralC.pkl', oortC_array)
pickle_data('./pickles/cold_spiralK.pkl', oortK_array)