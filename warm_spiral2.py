...
pickle_data('./pickles/warm_spiralA2.pkl', oortA_array)
pickle_data('./pickles/warm_spiralB2.pkl', oortB_array)
pickle_data('./pickles/warm_spiralC2.pkl', oortC_array)
pickle_data('./pickles/warm_spiralK2.pkl', oortK_array)